// Code generated by the Encore v1.38.8 client generator. DO NOT EDIT.
...
export function Environment(name: string): BaseURL {
    return `https://${name}-slackbot-regi.encr.app`
}
...
/**
 * Client is an API client for the slackbot-regi Encore application. 
 */
...
export namespace bot {
    ...
    export interface ListBotRequest {
        ids: string[]
    }
    ...
    export class ServiceClient {
         ...
         */
        public async Avatar(method: string, id: string, body?: BodyInit, options?: CallParameters): Promise<Response> {
            return this.baseClient.callAPI(method, `/bots/${encodeURIComponent(id)}/avatar`, body, options)
        }
         ...
         */
        public async Create(params: CreateBotRequest): Promise<CreateBotResponse> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callAPI("POST", `/bots`, JSON.stringify(params))
            return await resp.json() as CreateBotResponse
        }

        /**
         * Get returns a bot by ID.
         */
        public async Get(id: string): Promise<db.Bot> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callAPI("GET", `/bots/${encodeURIComponent(id)}`)
            return await resp.json() as db.Bot
        }

        /**
         * List returns a list of bots. If IDs is empty, it will return all bots.
         */
        public async List(params: ListBotRequest): Promise<Bots> {
            ...
            // Now make the actual call to the API
            const resp = await this.baseClient.callAPI("GET", `/bots`, undefined, {query})
            return await resp.json() as Bots
        }
    }
}
...
export namespace chat {
    ...
    export class ServiceClient {
         ...
         */
        public async AddBotToChannel(channelID: string, botID: string): Promise<void> {
         ...
         */
        public async ListChannels(params: ListChannelRequest): Promise<ListChannelsResponse> {
            // Convert our params into the objects we need for the request
            const query = makeRecord<string, string | string[]>({
            ...
            // Now make the actual call to the API
            const resp = await this.baseClient.callAPI("GET", `/chat/channels`, undefined, {query})
...
class BaseClient {
    ...
    constructor(baseURL: string, options: ClientOptions) {
        ...
        if (typeof window === "undefined") {
            this.headers["User-Agent"] = "slackbot-regi-Generated-TS-Client (Encore/v1.38.8)";
        }
