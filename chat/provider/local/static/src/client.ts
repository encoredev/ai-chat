// Code generated by the Encore v1.38.4 client generator. DO NOT EDIT.
...
export namespace bot {
    ...
    export class ServiceClient {
         ...
         */
        public async Create(params: CreateBotRequest): Promise<db.Bot> {
...
class BaseClient {
    ...
    constructor(baseURL: string, options: ClientOptions) {
        ...
        if (typeof window === "undefined") {
            this.headers["User-Agent"] = "slackbot-regi-Generated-TS-Client (Encore/v1.38.4)";
        }
