...
import {ExampleChatService} from "./components/service/ChatService";
...
const serviceFactory = (storage: IStorage, updateState: UpdateState) => {
  return new ExampleChatService(storage, updateState, "test", "stefan");
};
...
const chats = [
  {name: "test", storage: akaneStorage},
];
...
chats.forEach(c => {
  ...
  c.storage.addConversation(createConversation(conversationId, "test"));
  users.forEach(u => {
    if (u.name !== c.name) {
